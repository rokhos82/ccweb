						  ...
						  if(e.cust)
							{
    								...
    								d.container.animate({ height: h }, 150, function () {
    									closebtn.show();
    									content.show();
    									$('.duration').html(calcDuration(e.start, e.end, e.allDay, 0, 0, 0));
    								});
							}
							else
							{
    ...
    eventSources: [

            {
                events: [ // put the array in the `events` property
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-13 17:00:00',
                        end    : '2012-03-13 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    },
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-15 17:00:00',
                        end    : '2012-03-15 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-20 17:00:00',
                        end    : '2012-03-20 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-22 17:00:00',
                        end    : '2012-03-22 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-27 17:00:00',
                        end    : '2012-03-27 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-03-29 17:00:00',
                        end    : '2012-03-29 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-03 17:00:00',
                        end    : '2012-04-03 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-10 17:00:00',
                        end    : '2012-04-10 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-12 17:00:00',
                        end    : '2012-04-12 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-17 17:00:00',
                        end    : '2012-04-17 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-19 17:00:00',
                        end    : '2012-04-19 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-24 17:00:00',
                        end    : '2012-04-24 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Master Gardener Classes',
                        start  : '2012-04-26 17:00:00',
                        end    : '2012-04-26 19:00:00',
												allDay : false,
                        "className":"cat1 aec-repeating",
												"cust" : true,
												"content" : "Converse County Master Gardener Classes; Tuesdays and Thursdays (Douglas) 5:00 pm-7:00 pm"
                    ...
                    {
                        title  : 'Niobrara County Local Food Expo',
                        start  : '2012-04-12',
												allDay : true,
                        "className":"cat1",
												"cust" : true,
												"content" : "Niobrara County Local Food Expo (Lusk) all day"
                    },

										
                    {
                        title  : 'Rural Living Workshop',
                        start  : '2012-04-14 09:00:00',
                        end    : '2012-04-14 11:00:00',
												allDay : false,
                        "className":"cat1",
												"cust" : true,
												"content" : "Rural Living Workshop (Glenrock) 9:00am-11:00 am"
                    },
										
                    {
                        title  : 'Rural Living Workshop',
                        start  : '2012-04-21 09:00:00',
                        end    : '2012-04-21 11:00:00',
												allDay : false,
                        "className":"cat1",
												"cust" : true,
												"content" : "Rural Living Workshop (Glenrock) 9:00am-11:00 am"
                    ...
                    {
                        title  : 'State Master Gardener Conference',
                        start  : '2012-04-27',
                        end    : '2012-04-29',
												allDay : true,
                        "className":"cat1",
												"cust" : true,
												"content" : "State Master Gardener Conference (Gillette) all day"
                    },
										
                    {
                        title  : 'Rural Living Workshop',
                        start  : '2012-04-28 09:00:00',
                        end    : '2012-04-28 11:00:00',
												allDay : false,
                        "className":"cat1",
												"cust" : true,
												"content" : "Rural Living Workshop (Glenrock) 9:00am-11:00 am"
                    ...
                    {
                        title  : 'Rural Living Workshop',
                        start  : '2012-05-05 09:00:00',
                        end    : '2012-05-05 11:00:00',
												allDay : false,
                        "className":"cat1",
												"cust" : true,
												"content" : "Rural Living Workshop (Glenrock) 9:00am-11:00 am"
                    ...
                    {
                        title  : 'Management Intensive Grazing School',
                        start  : '2012-05-29',
                        end    : '2012-06-01',
												allDay : true,
                        "className":"cat1",
												"cust" : true,
												"content" : "Management Intensive Grazing School (Wheatland) all day"
                    }
                ],
